...
if [ -z "$DHT22" ]
	then 
		echo "Aktuell ist noch kein Pin für den Gebrauch mit einem DHT22 Luftfeuchte und Temperatursensor eingerichtet"
	else	
		echo "Aktuell sind folgende Pins für den Gebrauch mit einem DHT22 Luftfeuchte und Temperatursensor eingerichtet:"
		echo $DHT22	
fi
